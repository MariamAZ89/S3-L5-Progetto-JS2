...
*/
let whoIsBigger = function (param1, param2) {
  if (param1 >= param2) {
    console.log(param1 + " è piu grande");
  } else {
    console.log(param2 + " è piu grande");
  }
};
/* ESERCIZIO 3
...
*/
const deleteOne = function (param1, param2) {
  param1 = param1.split("");
  if (param2) {
    param1.pop();
    return param1;
...
*/
const onlyLetters = function (param) {
  param = param.split("");
  let newArray = param.filter((char) => {
...
console.log(onlyLetters("mariam89"));
...
console.log("_");
console.log(isThisAnEmail("mariam_89@gmail.com"));
...
console.log("_");
console.log(howManyDays(1989 - 11 - 15));
